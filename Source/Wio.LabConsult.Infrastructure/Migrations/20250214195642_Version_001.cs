        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Consult = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Price = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Category = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AppointmentCartMasterId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    AppointmentCartId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentsItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppointmentsItems_Appointments_AppointmentCartId",
                        column: x => x.AppointmentCartId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Consults_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestConfirmations", x => x.RequestId);
                    table.ForeignKey(
                        name: "FK_RequestConfirmations_Requests_RequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Images_Consults_ConsultId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequestsItems_Consults_ConsultId",
                        column: x => x.ConsultId,
                        principalTable: "Consults",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_Consults_ConsultId",
                        column: x => x.ConsultId,
                        principalTable: "Consults",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentsItems_AppointmentCartId",
                table: "AppointmentsItems",
                column: "AppointmentCartId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Consults_CategoryId",
                table: "Consults",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Images_ConsultId",
                table: "Images",
                column: "ConsultId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestsItems_ConsultId",
                table: "RequestsItems",
                column: "ConsultId");
